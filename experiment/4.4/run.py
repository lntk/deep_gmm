...
video_dataset = VideoSequenceDataset(
    data_file='experiment/4.4/CDnet2014_train.txt',
...
writer = SummaryWriter(log_dir="experiment/4.4/tensorboard")
...
for epoch in range(config.NUM_EPOCH):
    ...
    if running_loss < best_loss:
        ...
        }, filename=f"experiment/4.4/best_model_{best_loss}.pth")   
